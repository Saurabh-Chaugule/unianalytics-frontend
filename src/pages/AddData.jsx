          ...
          <div className="animate-in fade-in slide-in-from-right-4">
            {step === 1 && (
              <form onSubmit={generateGrid} className="max-w-2xl mx-auto space-y-6">
                 ...
                 <button type="submit" className="w-full py-4 bg-gradient-to-r from-blue-600 via-indigo-500 to-blue-600 animate-wave text-white rounded-xl font-bold flex justify-center items-center gap-2 hover:scale-105 shadow-[0_0_15px_rgba(79,70,229,0.4)] transition-transform">Proceed to Roster <ArrowRight size={18}/></button>
              </form>
            )}
            {step === 2 && (
              <div className="space-y-4 animate-in slide-in-from-right-4">
                 ...
                 <button onClick={handleBatchSubmit} className="w-full py-4 bg-gradient-to-r from-emerald-400 via-emerald-500 to-emerald-400 animate-wave text-white rounded-xl font-bold shadow-[0_0_15px_rgba(16,185,129,0.4)] hover:scale-105 transition-transform flex items-center justify-center"><Plus className="mr-2" size={20}/> Inject Batch Data</button>
              </div>
            )}
            {step === 3 && (
